...
public final class FieldDef {
    ...
    public FieldDef(SafeIdentifier name__1054, FieldType fieldType__1055, boolean nullable__1056) {
        this.name = name__1054;
        this.fieldType = fieldType__1055;
        this.nullable = nullable__1056;
    }
